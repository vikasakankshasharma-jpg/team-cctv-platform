...
export default function WizardPage() {
  ...
  return (
    <div className="flex-1 relative flex flex-col bg-white dark:bg-zinc-950 overflow-x-hidden transition-colors duration-500">
      ...
      <div className={`flex-1 transition-all duration-700 flex flex-col max-w-4xl mx-auto w-full px-6 pt-12 pb-32 md:pt-16 ${showGate ? "blur-3xl scale-[0.95] opacity-0 select-none pointer-events-none" : "opacity-100"}`}>
