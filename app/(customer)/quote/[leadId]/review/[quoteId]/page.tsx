    ...
    if (leadId === "mock-lead" || leadId === "mock-e2e-lead" || !adminDb) {
      ...
      quoteData = {
        ...
        billing_details: {
          ...
          city: quote?.billing_details?.city || lead?.address?.city || lead?.detected_city || lead?.wizard_answers?.city || lead?.wizard_answers?.q_city || "Jaipur",
          state: quote?.billing_details?.state || lead?.address?.state || lead?.detected_state || lead?.wizard_answers?.state || lead?.wizard_answers?.q_state || "Rajasthan",
          state_code: quote?.billing_details?.state_code || "08",
          pincode: quote?.billing_details?.pincode || lead?.address?.pincode || lead?.detected_pincode || lead?.wizard_answers?.pincode || lead?.wizard_answers?.q_pincode || "",
