    ...
    <div className="flex-1 flex flex-col bg-white dark:bg-zinc-950 transition-colors duration-500">
      ...
      <section className="relative px-6 pt-24 pb-32 md:pt-32 md:pb-48 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center relative">
          <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-white dark:bg-zinc-900/80 border border-zinc-200 dark:border-zinc-800 text-zinc-600 dark:text-zinc-400 text-[10px] font-black uppercase tracking-[0.2em] mb-12 shadow-2xl backdrop-blur-sm animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <span>Serving All of Jaipur</span>
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-zinc-900 dark:text-white tracking-tighter max-w-5xl mb-8 leading-[0.9] animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-700 via-indigo-600 to-blue-800 dark:from-blue-400 dark:via-blue-500 dark:to-indigo-500 italic">Across Jaipur.</span>
          </h1>
          ...
          <p className="text-lg md:text-2xl text-zinc-500 dark:text-zinc-400 max-w-3xl mb-12 font-medium leading-relaxed animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-200">
             Protect your home or business in the Pink City. Get an exact price for your CCTV setup online in under 2 minutes. We only use STQC compliant, government-approved hardware.
          </p>
      ...
      <section className="py-20 md:py-32 px-6 bg-zinc-50 dark:bg-zinc-900/30">
         <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
               <h2 className="text-4xl md:text-5xl font-black text-zinc-900 dark:text-white tracking-tighter mb-4">CCTV Installation Cost in Jaipur</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
               ...
               <div className="bg-zinc-900 dark:bg-blue-600 text-white p-10 rounded-[40px] shadow-2xl relative overflow-hidden">
                  ...
                  <p className="text-zinc-300 text-sm mb-8 leading-relaxed">Ideal for offices, warehouses, and factories in Sitapura or VKI. High-definition IP cameras with extended storage.</p>
                  <ul className="space-y-4 mb-8">
      ...
      <section className="py-24 px-6 relative">
         <div className="max-w-6xl mx-auto">
            <div className="flex flex-col items-center text-center mb-16">
               ...
               <h2 className="text-4xl md:text-5xl font-black text-zinc-900 dark:text-white tracking-tighter mb-4">Areas We Serve in Jaipur</h2>
      ...
      <section className="py-24 px-6 relative overflow-hidden text-center bg-zinc-950 transition-colors">
        <div className="max-w-4xl mx-auto flex flex-col items-center">
            <h2 className="text-5xl md:text-7xl font-black text-white tracking-tighter mb-8 leading-[0.9]">Secure your Jaipur <br/> property today.</h2>
