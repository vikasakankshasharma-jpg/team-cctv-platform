...
const additionsHi = `    step_timeline_desc: "आपको यह सिस्टम कितनी जल्दी इंस्टॉल करवाना है?",
...
const additionsMr = `    step_timeline_desc: "तुम्हाला हे सिस्टम किती लवकर स्थापित करायचे आहे?",
...
const additionsGu = `    step_timeline_desc: "તમારે આ સિસ્ટમ કેટલી જલ્દી ઇન્સ્ટોલ કરવાની જરૂર છે?",
...
// We'll just replace fopt_amc_no string taking into account it might not have a comma
content = content.replace(/fopt_amc_no: "नहीं, मैं खुद संभाल लूंगा"\\s*\\}/g, 'fopt_amc_no: "नहीं, मैं खुद संभाल लूंगा",\\n' + additionsHi + '\\n  }');
content = content.replace(/fopt_amc_no: "नाही, मी स्वतः व्यवस्थापन करेन"\\s*\\}/g, 'fopt_amc_no: "नाही, मी स्वतः व्यवस्थापन करेन",\\n' + additionsMr + '\\n  }');
content = content.replace(/fopt_amc_no: "ના, હું જાતે મેનેજ કરીશ"\\s*\\}/g, 'fopt_amc_no: "ના, હું જાતે મેનેજ કરીશ",\\n' + additionsGu + '\\n  }');
