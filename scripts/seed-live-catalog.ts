...
const RAW_PRODUCTS = [
  ...
  { sku: "ACC-4U-RACK-RECORDER", brand: "Budget Brand", category: "rack", description: "4U Rack for Recorder", base_cost: 450, technology: "Common" },
  { sku: "ACC-PVC-RACK-POE", brand: "Budget Brand", category: "rack", description: "PVC Rack for PoE Switch", base_cost: 450, technology: "IP" },
...
async function seedDatabase() {
  ...
  const filteredProducts = RAW_PRODUCTS.filter(p => p.brand !== "Hikvision" && p.brand !== "Dahua");
