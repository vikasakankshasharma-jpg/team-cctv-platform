...
const newLines = [...lines.slice(0, start), newSwitch, ...lines.slice(end)];
fs.writeFileSync("components/wizard/WizardClientV2.tsx", newLines.join("\n"));
console.log("Replaced renderStep lines exactly");
