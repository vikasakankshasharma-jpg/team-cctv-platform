...
export const GenerateQuoteSchema = z.object({
  ...
  camera_count: z.coerce.number().int().min(1).max(16),
  ...
  recording_days: z.coerce.number().int().min(0).max(365),
  selected_addons: z.array(z.string()).default([]),
  selected_camera_option: z.coerce.number().int().optional(),
  ...
  expected_total_payable: z.coerce.number().positive().optional(),
  ...
  max_budget: z.coerce.number().nullable().optional(),
  cable_length_meters: z.coerce.number().nullable().optional(),
  ...
  indoor_camera_count: z.coerce.number().int().nonnegative().nullable().optional(),
  outdoor_camera_count: z.coerce.number().int().nonnegative().nullable().optional(),
