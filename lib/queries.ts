      ...
      questions: [
        {
          ...
          options: [
            ...
            { id: "fopt_hd", label: "HD Analog Camera (Basic Budget)",   value: "Analog", position: 1 },
            { id: "opt_wifi", label: "Wireless Camera (WiFi/Solar)", value: "WiFi", position: 2 },
            { id: "opt_4g", label: "4G Cellular Camera (Requires SIM)", value: "4G", position: 3 },
          ],
        },
      ],
    },
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          position: 1,
          options: [
            { id: "ffopt_dome",   label: "Dome (Best for ceilings, vandal-resistant)", value: "Dome", position: 0 },
            { id: "ffopt_bullet", label: "Bullet (Best for walls, visible deterrent)", value: "Bullet", position: 1 },
          ],
        },
      ],
    },
      ...
      questions: [
        {
          ...
          position: 0,
          options: [
            { id: "opt_feat_audio", label: "Built-in Mic (Audio Recording)", value: "Audio", position: 0 },
            { id: "opt_feat_2way",  label: "Two-Way Audio (Mic + Speaker)", value: "Two-Way Audio", position: 1 },
            { id: "opt_feat_colorvu",label: "Color Night Vision (ColorVu)", value: "ColorVu", position: 2 },
            { id: "opt_feat_ptz",   label: "Pan-Tilt-Zoom (Optical Zoom & Motorized)", value: "PTZ", position: 3 },
            { id: "opt_feat_pt",    label: "Pan-Tilt (Motorized Rotation, No Optical Zoom)", value: "PT", position: 4 },
          ],
        },
      ],
    },
