...
const renderLoopRegex = /\{\["camera", "recorder", \.\.\.Object\.keys\(CATEGORIES\)\.filter\(k => \!\["camera", "recorder"\]\.includes\(k\)\)\]\.map\(\(cat\) => \{[\s\S]*?\}\)\}/;
...
// Also need to pass config to CategorySection properly. Wait, CategorySection reads from CATEGORIES globally?
// Let's check CategorySection.
