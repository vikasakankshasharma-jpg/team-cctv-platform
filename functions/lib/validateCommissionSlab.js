...
exports.validateCommissionSlab = void 0;
 ...
 */
exports.validateCommissionSlab = functions.https.onCall((data, context) => {
    // Ensure caller is at least a sales_staff or super_admin
    const role = context.auth?.token?.role;
    if (!context.auth || (role !== "super_admin" && role !== "sales_staff")) {
        throw new functions.https.HttpsError("permission-denied", "Only admins can validate commission slabs.");
    }
...
//# sourceMappingURL=validateCommissionSlab.js.map