...
export function PaymentSuccessClient({ quoteId, paymentId }: Props) {
  ...
  const whatsappUrl = `https://wa.me/917357612865?text=${encodeURIComponent(`Hi TEAM CCTV, I have a question regarding my recent booking (Quote ID: ${quoteId}, Payment ID: ${paymentId}).`)}`;
