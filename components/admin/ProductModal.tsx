  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-background border border-border rounded-2xl w-full max-w-2xl overflow-hidden shadow-xl animate-in zoom-in-95 fade-in duration-500 max-h-[90vh] flex flex-col">
        ...
        {/* Header Section */}
        <div className="p-4 md:p-8 pb-6 shrink-0 border-b border-border bg-secondary/30">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex-1 overflow-y-auto p-4 md:p-8 space-y-8 custom-scrollbar">
          ...
          <div className="flex justify-end gap-3 pt-4 sticky bottom-0 bg-background/80 backdrop-blur-md py-4 -mb-4">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="group relative flex items-center gap-2 bg-primary hover:bg-primary/90 text-primary-foreground px-4 md:px-8 py-2.5 rounded-full font-semibold text-sm transition-all shadow-sm active:scale-95 disabled:opacity-50"
            >
              {isSubmitting ? (
