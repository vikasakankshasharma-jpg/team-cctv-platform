...
export function AdminHeader({ userEmail, userRole }: AdminHeaderProps) {
  ...
  return (
    <header className="h-16 border-b border-zinc-100 dark:border-zinc-800/60 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-xl flex items-center justify-between px-6 z-20 shrink-0 gap-4">
