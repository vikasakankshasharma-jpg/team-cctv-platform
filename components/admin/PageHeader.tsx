      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <div className="flex items-center gap-3 mb-0.5">
            <h1 className="text-2xl font-black text-white tracking-tight leading-none uppercase">{title}</h1>
            {badge && (
              <span className="text-[8px] font-black text-zinc-400 uppercase tracking-[0.2em] bg-zinc-900 border border-zinc-800 px-2.5 py-1 rounded-full shadow-inner">
                {badge}
              </span>
            )}
          </div>
