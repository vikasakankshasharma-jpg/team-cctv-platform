...
import { Search, ArrowRight, User, Package, Calendar, TrendingDown, TrendingUp } from "lucide-react";
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm text-zinc-300">
            <thead className="bg-zinc-50 dark:bg-zinc-950/40 border-b border-zinc-200 dark:border-zinc-800/60 text-zinc-400 dark:text-zinc-600 font-black uppercase text-[10px] tracking-[0.25em]">
              <tr>
                <th className="px-8 py-6">Modification Event</th>
                <th className="px-8 py-6">Identity</th>
                <th className="px-8 py-6">Previous State</th>
                <th className="px-8 py-6">New Manifest</th>
