...
export function Sidebar() {
  ...
  return (
    <div className="w-64 bg-white/[0.02] backdrop-blur-3xl border-r border-white/10 flex flex-col h-screen sticky top-0 overflow-hidden transition-colors duration-500">
      {/* ── BRAND HEADER ──────────────────────────────────────────────────── */}
