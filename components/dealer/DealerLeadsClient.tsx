  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 p-6 md:p-10 font-sans">
      <div className="max-w-7xl mx-auto relative">
        ...
        {/* Search & Filters */}
        <div className="bg-white dark:bg-zinc-900/50 backdrop-blur-xl border border-zinc-100 dark:border-zinc-800 rounded-[32px] p-4 mb-8 flex flex-col md:flex-row gap-4 shadow-2xl shadow-zinc-200/40 dark:shadow-none">
          <div className="flex-1 relative">
            ...
            <input 
              ...
              className="w-full bg-zinc-50/50 dark:bg-zinc-950/40 border border-zinc-100 dark:border-zinc-800/60 rounded-2xl py-3.5 pl-12 pr-4 text-xs font-black uppercase tracking-widest text-zinc-900 dark:text-white placeholder:text-zinc-400 focus:ring-4 focus:ring-blue-500/5 focus:border-blue-500/50 outline-none transition-all"
            />
          </div>
          <div className="flex items-center gap-3">
             <div className="w-10 h-10 rounded-2xl bg-zinc-50 dark:bg-zinc-950/40 flex items-center justify-center border border-zinc-100 dark:border-zinc-800/60">
               <Filter className="w-4 h-4 text-zinc-400" />
             </div>
             <select 
               value={statusFilter}
               onChange={(e) => setStatusFilter(e.target.value)}
               className="bg-zinc-50 dark:bg-zinc-950/40 border border-zinc-100 dark:border-zinc-800/60 rounded-2xl py-3.5 px-6 text-[10px] font-black uppercase tracking-widest text-zinc-600 dark:text-zinc-400 focus:ring-4 focus:ring-blue-500/5 outline-none transition-all cursor-pointer hover:bg-zinc-100 dark:hover:bg-zinc-900"
             >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
           {filteredLeads.length === 0 ? (
             <div className="col-span-full py-32 text-center">
                <div className="w-20 h-20 bg-zinc-100 dark:bg-zinc-800/60 rounded-[32px] flex items-center justify-center mx-auto mb-6">
             ...
             filteredLeads.map((lead) => (
               <div 
                 ...
                 className="bg-white dark:bg-zinc-900/50 backdrop-blur-xl border border-zinc-100 dark:border-zinc-800 rounded-[36px] p-8 shadow-2xl shadow-zinc-200/50 dark:shadow-none hover:shadow-blue-500/10 hover:border-blue-500/30 transition-all cursor-pointer group flex flex-col relative overflow-hidden"
               >
                  ...
                  <div className="space-y-3.5 mb-10">
                     <div className="flex items-center gap-3 text-[11px] font-black uppercase tracking-widest text-zinc-500 dark:text-zinc-400">
                        <div className="w-7 h-7 rounded-lg bg-zinc-50 dark:bg-zinc-950/40 flex items-center justify-center border border-zinc-100 dark:border-zinc-800/60">
                  ...
                  <div className="mt-auto pt-6 border-t border-zinc-50 dark:border-zinc-800/60 flex justify-between items-center">
